  ...
  const announcements = [
    {
      ...
      content:
        "Reminder: Faculty meeting this Friday at 3:00 PM in the Conference Room.",
      date: "2023-08-16",
    },
    {
      id: 2,
      ...
      content:
        "The deadline for submitting final grades for the Summer semester is August 25.",
      date: "2023-08-10",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Student enrollment requests awaiting your approval
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your teaching schedule for the next few days
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
